...
use CeresVanilla\Extensions\TwigMegaSlider;
...
class CeresVanillaServiceProvider extends ServiceProvider
{
    ...
    {
        $twig->addExtension(TwigMegaSlider::class);
        ...
        if (in_array("checkout", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            $eventDispatcher->listen('IO.tpl.checkout', function (TemplateContainer $container)
            {
        ...
        if (in_array("login", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            $eventDispatcher->listen('IO.tpl.login', function (TemplateContainer $container)
            {
        ...
        if (in_array("register", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            $eventDispatcher->listen('IO.tpl.register', function (TemplateContainer $container)
            {
        ...
        if (in_array("cancellation_rights", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            $eventDispatcher->listen('IO.tpl.cancellation-rights', function (TemplateContainer $container)
            {
        ...
        if (in_array("legal_disclosure", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            $eventDispatcher->listen('IO.tpl.legal-disclosure', function (TemplateContainer $container)
            {
        ...
        if (in_array("item_not_found", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            $eventDispatcher->listen('IO.tpl.item-not-found', function (TemplateContainer $container)
            {
        ...
        if (in_array("page_not_found", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            $eventDispatcher->listen('IO.tpl.page-not-found', function (TemplateContainer $container)
            {
